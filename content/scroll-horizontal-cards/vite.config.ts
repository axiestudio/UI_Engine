...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "ScrollHorizontalCards", formats: ["es","cjs"], fileName: (f) => (f==="es"?"scroll-horizontal-cards.es.js":"scroll-horizontal-cards.cjs.js") },
