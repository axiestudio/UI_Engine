...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "ScrollPinnedPanels", formats: ["es","cjs"], fileName: (f) => (f==="es"?"scroll-pinned-panels.es.js":"scroll-pinned-panels.cjs.js") },
