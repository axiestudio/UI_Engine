...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "InteractiveHorizonSlider", formats: ["es","cjs"], fileName: (f) => (f==="es"?"interactive-horizon-slider.es.js":"interactive-horizon-slider.cjs.js") },
