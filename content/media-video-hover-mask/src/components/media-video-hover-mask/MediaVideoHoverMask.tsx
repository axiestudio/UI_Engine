  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border bg-foreground"
      ...
      <div className="relative aspect-[4/3]">
        <video ref={ref} className="h-full w-full scale-105 object-cover" src={card.src ?? "/videos/hero.mp4"} loop muted playsInline preload="metadata" />
        {/* masked wipe */}
        ...
        <span className="absolute left-1/2 top-1/2 h-[150%] w-[0%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[hsl(var(--site-accent)/0.2)] blur-2xl transition-all duration-500 group-hover:w-[130%]" />
      </div>
