...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "MediaVideoHoverMask", formats: ["es","cjs"], fileName: (f) => (f==="es"?"media-video-hover-mask.es.js":"media-video-hover-mask.cjs.js") },
