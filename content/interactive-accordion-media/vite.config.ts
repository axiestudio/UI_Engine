...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "InteractiveAccordionMedia", formats: ["es","cjs"], fileName: (f) => (f==="es"?"interactive-accordion-media.es.js":"interactive-accordion-media.cjs.js") },
