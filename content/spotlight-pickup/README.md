...
Dark-stage grid lit by a cursor torch — menu/collection reveal
...
From the repo root: `npm run build:spotlight-pickup` (or `npm run build:presets`). Engine consumes it via the `file:` dependency.
