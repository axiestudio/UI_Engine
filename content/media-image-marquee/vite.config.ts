...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "MediaImageMarquee", formats: ["es","cjs"], fileName: (f) => (f==="es"?"media-image-marquee.es.js":"media-image-marquee.cjs.js") },
