...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "ScrollScaleReveal", formats: ["es","cjs"], fileName: (f) => (f==="es"?"scroll-scale-reveal.es.js":"scroll-scale-reveal.cjs.js") },
