...
Silent-film intermission break between chapters — spoked shutter wipe
...
From the repo root: `npm run build:intermission-card` (or `npm run build:presets`). Engine consumes it via the `file:` dependency.
