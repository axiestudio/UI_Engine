...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "ScrollPinnedChapters", formats: ["es","cjs"], fileName: (f) => (f==="es"?"scroll-pinned-chapters.es.js":"scroll-pinned-chapters.cjs.js") },
