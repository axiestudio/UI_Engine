...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "InteractiveSplitPane", formats: ["es","cjs"], fileName: (f) => (f==="es"?"interactive-split-pane.es.js":"interactive-split-pane.cjs.js") },
