...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "InteractiveConfiguratorMulti", formats: ["es","cjs"], fileName: (f) => (f==="es"?"interactive-configurator-multi.es.js":"interactive-configurator-multi.cjs.js") },
