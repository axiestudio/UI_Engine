...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "TestimonialMarquee", formats: ["es","cjs"], fileName: (f) => (f==="es"?"testimonial-marquee.es.js":"testimonial-marquee.cjs.js") },
