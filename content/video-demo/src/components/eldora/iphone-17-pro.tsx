/**
 * Vendored from Eldora UI (MIT): iphone-17-pro — device mockup frame.
 * Snapshot: UI/_registry/eldora-ui/r/iphone-17-pro.json
 * Local patch: clipPath id suffixed per component to avoid SVG id collisions.
 */
    ...
    >
      ...
      {src && (
        <image
          ...
          clipPath="url(#roundedCorners-iphone-17-pro)"
        />
      )}
      <path
        fill="#000000"
      ...
      <defs>
        <clipPath id="roundedCorners-iphone-17-pro">
          <rect
            fill="#ffffff"
            x="14.08"
            y="12.81"
