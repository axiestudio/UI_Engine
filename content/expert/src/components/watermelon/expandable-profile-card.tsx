/**
 * Vendored from Watermelon UI registry: https://registry.watermelon.sh/r/expandable-profile-card.json
 * Item: expandable-profile-card (type registry:ui). Snapshot: UI/_registry/watermelon/r/expandable-profile-card.json
 */
