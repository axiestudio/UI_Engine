...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "StoryScrubTimeline", formats: ["es","cjs"], fileName: (f) => (f==="es"?"story-scrub-timeline.es.js":"story-scrub-timeline.cjs.js") },
