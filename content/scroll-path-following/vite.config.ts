...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "ScrollPathFollowing", formats: ["es","cjs"], fileName: (f) => (f==="es"?"scroll-path-following.es.js":"scroll-path-following.cjs.js") },
