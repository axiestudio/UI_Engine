...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "InteractiveScrollTriggeredTabs", formats: ["es","cjs"], fileName: (f) => (f==="es"?"interactive-scroll-triggered-tabs.es.js":"interactive-scroll-triggered-tabs.cjs.js") },
