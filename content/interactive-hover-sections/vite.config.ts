...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "InteractiveHoverSections", formats: ["es","cjs"], fileName: (f) => (f==="es"?"interactive-hover-sections.es.js":"interactive-hover-sections.cjs.js") },
