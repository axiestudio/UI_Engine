...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "InteractiveTiltCards", formats: ["es","cjs"], fileName: (f) => (f==="es"?"interactive-tilt-cards.es.js":"interactive-tilt-cards.cjs.js") },
