...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "MediaFullscreenLightbox", formats: ["es","cjs"], fileName: (f) => (f==="es"?"media-fullscreen-lightbox.es.js":"media-fullscreen-lightbox.cjs.js") },
