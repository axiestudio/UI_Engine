  ...
  return (
    <span
      ...
      className={cn(
        ...
        dark
          ? "bg-[linear-gradient(105deg,transparent_42%,rgba(0,0,0,0.04)_50%,transparent_58%)]"
          : "bg-[linear-gradient(105deg,transparent_42%,rgba(255,255,255,0.14)_50%,transparent_58%)]",
        className,
      )}
    />
  )
