/**
 * Vendored from Watermelon UI registry: https://registry.watermelon.sh/r/carousel-slider.json
 * Item: carousel-slider (type registry:ui). Snapshot: UI/_registry/watermelon/r/carousel-slider.json
 */
"use client";
