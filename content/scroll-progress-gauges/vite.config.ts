...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "ScrollProgressGauges", formats: ["es","cjs"], fileName: (f) => (f==="es"?"scroll-progress-gauges.es.js":"scroll-progress-gauges.cjs.js") },
