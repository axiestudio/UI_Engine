...
every part of the composition is its own exported component in `src/components/stack-proof/layers/`, and the
composed section (`StackProof`) imports the layers and stacks them.
