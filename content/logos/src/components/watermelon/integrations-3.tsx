...
export default function Integraations3() {
  return (
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {integrations.map((item) => {
            ...
            return (
              ...
              >
                <div className="bg-background mb-4 flex h-10 w-10 items-center justify-center rounded-lg border dark:shadow-[inset_0_0_2px_2px_rgba(255,255,255,0.04),inset_0_0_0_1px_rgba(255,255,255,0.08),0px_0px_0px_1px_rgba(255,255,255,0.06),0px_1px_2px_-1px_rgba(0,0,0,0.5),0px_2px_4px_0px_rgba(0,0,0,0.4)] shadow-[inset_0_0_2px_1px_rgba(255,255,255,0.03),inset_0_0_0_1px_rgba(255,255,255,0.02),0px_0px_0px_0px_rgba(255,255,255,0.03),0px_1px_2px_-1px_rgba(0,0,0,0.03),0px_2px_4px_0px_rgba(0,0,0,0.1)]">
