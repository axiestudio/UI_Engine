...
const Shopify = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} viewBox="0 0 256 292" preserveAspectRatio="xMidYMid">
    <path
...
const Calcom = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} viewBox="0 0 101 22" fill="none">
    <path
...
const Twitter = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} viewBox="0 0 256 209" preserveAspectRatio="xMidYMid">
    <path
...
export default function Integrations2() {
  return (
    <div className="theme-injected bg-background w-full py-16">
      <div className="mx-auto max-w-6xl px-6">
        <div className="bg-border border-border grid grid-flow-row-dense grid-cols-2 gap-px overflow-hidden rounded-none border sm:grid-cols-3 md:grid-cols-6 lg:grid-cols-4">
          ...
          <div className="bg-muted/50 relative col-span-2 row-span-2 flex flex-col items-center justify-center overflow-hidden p-6 text-center shadow-[inset_0_0px_10px_2px_rgba(0,0,0,0.15)] sm:col-span-3 md:col-span-6 lg:col-span-2 dark:shadow-[inset_0_0px_10px_2px_rgba(0,0,0,0.5)]">
            <div className="bg-[repeating-linear-gradient(135deg,theme(colors.border)_0px,theme(colors.border)_1px,transparent_1px,transparent_10px)] pointer-events-none absolute inset-0 mask-radial-at-center opacity-[0.5]" />

            <div className="relative z-10">
              <h3 className="text-foreground mb-5 max-w-[260px] text-lg leading-snug font-medium sm:text-xl">
                Designed for teams that ship and scale
              </h3>
            </div>
          </div>
