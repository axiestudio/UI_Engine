...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "InteractiveMagneticMenu", formats: ["es","cjs"], fileName: (f) => (f==="es"?"interactive-magnetic-menu.es.js":"interactive-magnetic-menu.cjs.js") },
