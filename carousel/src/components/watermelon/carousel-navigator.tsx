/**
 * Vendored from Watermelon UI registry: https://registry.watermelon.sh/r/carousel-navigator.json
 * Item: carousel-navigator (type registry:ui). Snapshot: UI/_registry/watermelon/r/carousel-navigator.json
 */
"use client";
