/**
 * Vendored from Watermelon UI registry: https://registry.watermelon.sh/r/dropdown-menu.json
 * Item: dropdown-menu (type registry:ui). Snapshot: UI/_registry/watermelon/r/dropdown-menu.json
 */
'use client';
