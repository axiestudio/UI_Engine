  ...
  theme: {
    extend: {
      colors: {
        ...
        "app-mood-dawn": "hsl(var(--app-mood-dawn) / <alpha-value>)",
        "app-mood-ink": "hsl(var(--app-mood-ink) / <alpha-value>)",
        "app-mood-moss": "hsl(var(--app-mood-moss) / <alpha-value>)",
        "app-mood-clay": "hsl(var(--app-mood-clay) / <alpha-value>)",
      },
