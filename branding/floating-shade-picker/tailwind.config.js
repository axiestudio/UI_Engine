  ...
  theme: {
    extend: {
      colors: {
        ...
        "app-shade-teal": "hsl(var(--app-shade-teal))",
        "app-shade-amber": "hsl(var(--app-shade-amber))",
        "app-shade-violet": "hsl(var(--app-shade-violet))",
        "app-shade-rose": "hsl(var(--app-shade-rose))",
        "app-shade-blue": "hsl(var(--app-shade-blue))",
        "app-shade-fern": "hsl(var(--app-shade-fern))",
        "app-shade-red": "hsl(var(--app-shade-red))",
        "app-shade-brass": "hsl(var(--app-shade-brass))",
      },
