  ...
  theme: {
    extend: {
      colors: {
        ...
        "app-paper": "hsl(var(--app-paper) / <alpha-value>)",
        "app-signal-orange": "hsl(var(--app-signal-orange) / <alpha-value>)",
        "app-ink": "hsl(var(--app-ink) / <alpha-value>)",
        "app-stone": "hsl(var(--app-stone) / <alpha-value>)",
        "app-moss": "hsl(var(--app-moss) / <alpha-value>)",
      },
