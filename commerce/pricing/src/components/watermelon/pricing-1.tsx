/**
 * Vendored from Watermelon UI registry: https://registry.watermelon.sh/r/pricing-1.json
 * Item: pricing-1 (type registry:ui). Fetched 2026-08-30. Do not edit unless intentionally adopting upstream changes.
 */
