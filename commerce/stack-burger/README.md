...
every part of the composition is its own exported component in `src/components/stack-burger/layers/`, and the
composed section (`StackBurger`) imports the layers and stacks them.
