...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "CommerceBundleBuilder", formats: ["es","cjs"], fileName: (f) => (f==="es"?"commerce-bundle-builder.es.js":"commerce-bundle-builder.cjs.js") },
