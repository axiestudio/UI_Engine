...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "CommerceLoyaltyTier", formats: ["es","cjs"], fileName: (f) => (f==="es"?"commerce-loyalty-tier.es.js":"commerce-loyalty-tier.cjs.js") },
