/**
 * Vendored from Watermelon UI registry: https://registry.watermelon.sh/r/feedback-action.json
 * Item: feedback-action (type registry:ui). Snapshot: UI/_registry/watermelon/r/feedback-action.json
 */
