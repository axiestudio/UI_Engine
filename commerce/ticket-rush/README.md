...
Drop scarcity — LED odometer counting stock away after the scramble
...
From the repo root: `npm run build:ticket-rush` (or `npm run build:presets`). Engine consumes it via the `file:` dependency.
