...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "CommerceQuickview", formats: ["es","cjs"], fileName: (f) => (f==="es"?"commerce-quickview.es.js":"commerce-quickview.cjs.js") },
