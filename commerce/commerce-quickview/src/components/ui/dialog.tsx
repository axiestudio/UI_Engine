/**
 * Vendored from Watermelon UI registry: https://registry.watermelon.sh/r/dialog.json
 * Item: dialog (type registry:ui). Snapshot: UI/_registry/watermelon/r/dialog.json
 */
'use client';
