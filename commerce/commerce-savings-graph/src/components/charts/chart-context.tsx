/**
 * Vendored from Bklit UI registry: https://ui.bklit.com/r/chart-context.json
 * Item: chart-context (type registry:component). Snapshot: UI/_registry/bklit/r/chart-context.json
 */
"use client";
