/**
 * Vendored from Bklit UI registry: https://ui.bklit.com/r/chart-tooltip.json
 * Item: chart-tooltip (type registry:component). Snapshot: UI/_registry/bklit/r/chart-tooltip.json
 */
