...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "CommerceProductGallery", formats: ["es","cjs"], fileName: (f) => (f==="es"?"commerce-product-gallery.es.js":"commerce-product-gallery.cjs.js") },
