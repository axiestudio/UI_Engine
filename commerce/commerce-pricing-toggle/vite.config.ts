...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "CommercePricingToggle", formats: ["es","cjs"], fileName: (f) => (f==="es"?"commerce-pricing-toggle.es.js":"commerce-pricing-toggle.cjs.js") },
