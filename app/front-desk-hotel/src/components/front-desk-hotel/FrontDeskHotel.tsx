                  ...
                  return (
                    <li key={c.id}>
                      <button
                        ...
                        className="flex w-full items-center gap-3 px-5 py-2 text-left focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-ring hover:bg-muted/40"
                      >
