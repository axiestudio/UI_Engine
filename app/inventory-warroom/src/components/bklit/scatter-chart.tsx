// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/scatter-chart.tsx — fetched 2026-09-01
...
export interface ScatterChartProps {
  ...
  className?: string;
  /** Optional x-label formatter — lets numeric encodings (e.g. epoch-encoded
   * days-of-stock) render domain-true tick labels instead of dates. */
