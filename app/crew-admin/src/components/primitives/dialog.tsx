/**
 * Vendored from motion-primitives by ibelick (MIT): components/core/dialog.tsx
 * Snapshot: UI/_registry/motion-primitives/components-core/dialog.tsx (local tokenized variant)
 */
'use client';
