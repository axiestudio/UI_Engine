// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/chart-loading-label.tsx — fetched 2026-09-01
// Adapted: import "../components/shimmering-text" rewritten to "../primitives/shimmering-text" (shimmering-text vendored as a primitive); "use client" directive stripped for library build
