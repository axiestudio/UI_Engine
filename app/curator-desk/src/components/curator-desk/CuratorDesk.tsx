            ...
            <div className="grid gap-1.5 p-3 text-[12px]">
              {[
                ...
                <div key={k} className="flex items-center justify-between rounded-md border bg-background px-2.5 py-1.5">
                  <span className="flex items-center gap-2"><span className="font-mono text-[11px] font-semibold tabular-nums text-muted-foreground text-muted-foreground">{String(i + 1).padStart(2, "0")}</span> {k}</span>
