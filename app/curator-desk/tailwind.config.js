  ...
  theme: {
    extend: {
      colors: {
        ...
        "app-wall": "hsl(var(--wall))",
        "app-shelf": "hsl(var(--wall-shelf))",
        "app-frame": "hsl(var(--frame))",
        "app-painting-cool": "hsl(var(--painting-cool))",
        "app-painting-cool-deep": "hsl(var(--painting-cool-deep))",
        "app-painting-warm": "hsl(var(--painting-warm))",
        "app-painting-warm-deep": "hsl(var(--painting-warm-deep))",
      },
