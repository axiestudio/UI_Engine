// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/bar-y-axis.tsx — fetched 2026-09-01
// Adapted: verbatim — zinc var() fallback mapped in host index.css
"use client";
