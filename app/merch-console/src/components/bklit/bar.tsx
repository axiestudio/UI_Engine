// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/bar.tsx — fetched 2026-09-01
// Adapted: verbatim — bar-depth-geometry import resolved by reimplemented local module
"use client";
