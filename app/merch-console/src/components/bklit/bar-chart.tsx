// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/bar-chart.tsx — fetched 2026-09-01
// Adapted: verbatim — bar-squares-layout import resolved by reimplemented local module
"use client";
