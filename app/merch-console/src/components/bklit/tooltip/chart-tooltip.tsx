// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/tooltip/chart-tooltip.tsx — fetched 2026-09-01
// Adapted: verbatim — no changes beyond header
"use client";
