// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/loading-sweep.tsx — fetched 2026-09-01
// Adapted: verbatim — @visx/shape + @visx/scale declared in host peers
"use client";
