// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/grid.tsx — fetched 2026-09-01
// Adapted: verbatim — @visx/grid declared in host peers; shared with the cartesian stack
"use client";
