// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/bar-x-axis.tsx — fetched 2026-09-01
// Adapted: verbatim — text-chart-label utility mapped to --chart-label in host tailwind theme
"use client";
