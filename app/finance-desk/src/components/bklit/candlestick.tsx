// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/candlestick.tsx — fetched 2026-09-01
// Adapted: verbatim — emerald/red var() colors mapped to app tokens in host index.css
"use client";
