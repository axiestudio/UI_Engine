// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/reference-area-geometry.ts — fetched 2026-09-01
// Adapted: verbatim — no local imports
