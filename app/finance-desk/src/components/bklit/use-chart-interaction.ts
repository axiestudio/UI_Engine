// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/use-chart-interaction.ts — fetched 2026-09-01
// Adapted: verbatim — @visx/event + @visx/scale declared in host peers
"use client";
