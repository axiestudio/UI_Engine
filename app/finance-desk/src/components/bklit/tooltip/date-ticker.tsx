// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/tooltip/date-ticker.tsx — fetched 2026-09-01
// Adapted: verbatim — zinc Tailwind vars mapped in host index.css
"use client";
