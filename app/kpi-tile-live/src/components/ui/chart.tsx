// Vendored / reimplemented from shadcn/ui chart (MIT) — https://ui.shadcn.com/docs/components/base/chart — fetched 2026-09-01
// Adapted: trimmed to ChartContainer + ChartTooltip + ChartTooltipContent (legend surface
// dropped); tailwind v4 syntax lowered to v3.4 (`outline-hidden` → `outline-none`,
// `border-(--x)` / `bg-(--x)` → `border-[var(--x)]` / `bg-[var(--x)]`).
