// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/funnel-chart.tsx — fetched 2026-09-01
// Adapted: import rewrites only ("@/lib/utils" alias preserved via vite/ts paths); default color resolves via full-hsl chart tokens defined in this package's index.css.
"use client";
