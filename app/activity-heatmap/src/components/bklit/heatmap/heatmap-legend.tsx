// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/heatmap/heatmap-legend.tsx — fetched 2026-09-01
...
export const HeatmapLegend = memo(function HeatmapLegend({
  ...
  return (
    <div
      className={cn(
        "flex w-full items-center gap-1.5 text-muted-foreground text-xs",
