// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/heatmap/heatmap-colors.ts — fetched 2026-09-01
// Adapted: --chart-scale-* tokens resolved from this package's src/index.css (full hsl() values); trimmed pattern color-mix helper usage kept for pattern paths
