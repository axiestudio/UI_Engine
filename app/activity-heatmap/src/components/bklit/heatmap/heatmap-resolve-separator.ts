// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/heatmap/heatmap-resolve-separator.ts — fetched 2026-09-01
// Adapted: no changes (import paths preserved)
