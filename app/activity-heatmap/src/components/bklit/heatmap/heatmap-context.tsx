// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/heatmap/heatmap-context.tsx — fetched 2026-09-01
// Adapted: stripped "use client" directive (library build); trimmed deprecated heatmapCssVars export
