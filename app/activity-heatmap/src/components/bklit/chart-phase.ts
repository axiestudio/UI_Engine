// Vendored from Bklit UI (MIT) — https://github.com/bklit/bklit-ui · packages/ui/src/charts/chart-phase.ts — fetched 2026-09-01
// Adapted: trimmed unused DEFAULT_CHART_LIFECYCLE constant (heatmap family only)
