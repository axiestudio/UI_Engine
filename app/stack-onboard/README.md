...
every part of the composition is its own exported component in `src/components/stack-onboard/layers/`, and the
composed section (`StackOnboard`) imports the layers and stacks them.
