/**
 * Vendored from Watermelon UI registry: https://registry.watermelon.sh/r/hover-card.json
 * Item: hover-card (registry:ui). Snapshot: UI/_registry/watermelon/r/hover-card.json
 */
'use client';
