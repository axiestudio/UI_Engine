...
export default defineConfig({
  ...
  build: {
    lib: {
      ...
      name: "ReleaseCaptain",
      formats: ["es", "cjs"],
      fileName: (format) => (format === "es" ? "release-captain.es.js" : "release-captain.cjs.js"),
    },
    rollupOptions: { external: ["@radix-ui/react-slot", "@radix-ui/react-switch", "class-variance-authority", "clsx", "lucide-react", "motion", "motion/react", "react", "react-dom", "react-slot", "react/jsx-runtime", "tailwind-merge"] },
    cssCodeSplit: false,
  },
})
