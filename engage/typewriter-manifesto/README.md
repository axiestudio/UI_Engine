...
Values typed at 220wpm with caret beat — mono manifesto
...
From the repo root: `npm run build:typewriter-manifesto` (or `npm run build:presets`). Engine consumes it via the `file:` dependency.
