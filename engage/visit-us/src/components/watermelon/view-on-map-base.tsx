/**
 * Vendored from Watermelon UI registry: https://registry.watermelon.sh/r/view-on-map-base.json
 * Item: view-on-map-base (type registry:ui). Fetched 2026-08-29. Do not edit unless intentionally adopting upstream changes.
 */
'use client';
          ...
          <AnimatePresence mode="popLayout">
            {!isOpen ? (
              ...
              <motion.div
                key="map"
                layoutId="map-container"
                className="bg-muted relative aspect-square w-[calc(w-full-64px)] overflow-hidden shadow-lg transition-colors duration-300 sm:w-[380px]"
