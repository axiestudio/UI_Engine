...
Wax-stamp letter that seals and folds in place — the confirmation moment
...
From the repo root: `npm run build:stamp-fold` (or `npm run build:presets`). Engine consumes it via the `file:` dependency.
