...
Pricing as floors — floor indicator counts up, doors part per plan
...
From the repo root: `npm run build:elevator-floors` (or `npm run build:presets`). Engine consumes it via the `file:` dependency.
