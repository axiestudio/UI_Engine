            ...
            >
              {floors.map((f, i) => (
                <RadioGroupItem
                  ...
                  value={String(i)}
                  className={cn(
                    "group flex h-[72px] w-auto aspect-auto flex-col items-center justify-center gap-1 rounded-2xl border-2 px-2 font-mono text-[10px] font-bold uppercase tracking-[0.12em] shadow-none transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--lift-panel))] focus-visible:ring-offset-2 focus-visible:ring-offset-[hsl(var(--lift-shaft))] data-[state=checked]:border-[hsl(var(--lift-panel))] data-[state=checked]:bg-[hsl(var(--lift-panel))] data-[state=checked]:text-[hsl(var(--lift-shaft))] data-[state=checked]:shadow-[0_6px_20px_hsl(var(--lift-panel)/0.35)] data-[state=unchecked]:border-white/15 data-[state=unchecked]:bg-white/[0.03] data-[state=unchecked]:text-white/70 hover:border-white/30 hover:bg-white/[0.07] hover:text-white",
                  )}
                >
