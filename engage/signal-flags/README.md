...
Maritime semaphore flags spell the call — hover replays the wave
...
From the repo root: `npm run build:signal-flags` (or `npm run build:presets`). Engine consumes it via the `file:` dependency.
