...
export function HeroCards({
  ...
  const cardCls = (depth: number) =>
    cn(
      "absolute inset-x-0 rounded-2xl border bg-card p-5 text-left shadow-sm ring-1 ring-foreground/[0.04] transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] motion-reduce:transition-none",
