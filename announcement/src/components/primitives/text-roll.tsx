/**
 * Vendored verbatim from motion-primitives by ibelick (MIT). components/core/text-roll.tsx — fetched 2026-08-30. Do not edit casually.
 */
'use client';
import { motion, type VariantLabels, type Target, type TargetAndTransition, type Transition } from 'motion/react';
