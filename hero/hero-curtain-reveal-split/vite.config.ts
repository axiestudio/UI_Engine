...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "HeroCurtainRevealSplit", formats: ["es","cjs"], fileName: (f) => (f==="es"?"hero-curtain-reveal-split.es.js":"hero-curtain-reveal-split.cjs.js") },
