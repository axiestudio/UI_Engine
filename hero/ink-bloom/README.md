...
Headline soaks in like ink on paper — blur-to-sharp mask bloom
...
From the repo root: `npm run build:ink-bloom` (or `npm run build:presets`). Engine consumes it via the `file:` dependency.
