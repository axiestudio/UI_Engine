  ...
  theme: {
    extend: {
      colors: {
        ...
        lime: "hsl(var(--lime))",
        sportink: "hsl(var(--sport-ink))",
        ink: "hsl(var(--foreground))",
      },
      borderRadius: { lg: "var(--radius)", md: "calc(var(--radius) - 1px)", sm: "calc(var(--radius) - 1px)" },
