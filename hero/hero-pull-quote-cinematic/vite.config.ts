...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "HeroPullQuoteCinematic", formats: ["es","cjs"], fileName: (f) => (f==="es"?"hero-pull-quote-cinematic.es.js":"hero-pull-quote-cinematic.cjs.js") },
