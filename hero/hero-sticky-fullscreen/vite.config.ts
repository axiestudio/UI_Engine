...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "HeroStickyFullscreen", formats: ["es","cjs"], fileName: (f) => (f==="es"?"hero-sticky-fullscreen.es.js":"hero-sticky-fullscreen.cjs.js") },
