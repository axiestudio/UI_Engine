/**
 * Vendored verbatim from motion-primitives by ibelick (MIT): components/core/text-roll.tsx
 */
'use client';
import type { VariantLabels, Target, TargetAndTransition, Transition } from 'motion/react';
