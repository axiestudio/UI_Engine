...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "MiscInteractiveBg", formats: ["es","cjs"], fileName: (f) => (f==="es"?"misc-interactive-bg.es.js":"misc-interactive-bg.cjs.js") },
