...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "TypographyOutline", formats: ["es","cjs"], fileName: (f) => (f==="es"?"typography-outline.es.js":"typography-outline.cjs.js") },
