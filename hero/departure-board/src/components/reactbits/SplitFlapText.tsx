/**
 * Vendored from React Bits registry: https://reactbits.dev/r/SplitFlapText-TS-TW.json
 * Item: SplitFlapText-TS-TW. Snapshot: UI/_registry/react-bits/r/SplitFlapText-TS-TW.json
 */
