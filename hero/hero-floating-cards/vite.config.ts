...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "HeroFloatingCards", formats: ["es","cjs"], fileName: (f) => (f==="es"?"hero-floating-cards.es.js":"hero-floating-cards.cjs.js") },
