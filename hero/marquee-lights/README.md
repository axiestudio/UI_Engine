...
Premiere bulb-frame masthead — chase lights orbit the big date
...
From the repo root: `npm run build:marquee-lights` (or `npm run build:presets`). Engine consumes it via the `file:` dependency.
