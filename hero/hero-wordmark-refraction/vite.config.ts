...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "HeroWordmarkRefraction", formats: ["es","cjs"], fileName: (f) => (f==="es"?"hero-wordmark-refraction.es.js":"hero-wordmark-refraction.cjs.js") },
