...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "TypeOutlineReveal", formats: ["es","cjs"], fileName: (f) => (f==="es"?"type-outline-reveal.es.js":"type-outline-reveal.cjs.js") },
