...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "TypographyCharAnim", formats: ["es","cjs"], fileName: (f) => (f==="es"?"typography-char-anim.es.js":"typography-char-anim.cjs.js") },
