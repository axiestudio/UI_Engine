...
Playbill masthead — credits columns, act numbers, ticket-stub CTA
...
From the repo root: `npm run build:house-programme` (or `npm run build:presets`). Engine consumes it via the `file:` dependency.
