...
Lineup reveal — performer cards take individual staggered bows
...
From the repo root: `npm run build:encore-bows` (or `npm run build:presets`). Engine consumes it via the `file:` dependency.
