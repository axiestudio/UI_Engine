...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "TypeScrambleTagline", formats: ["es","cjs"], fileName: (f) => (f==="es"?"type-scramble-tagline.es.js":"type-scramble-tagline.cjs.js") },
