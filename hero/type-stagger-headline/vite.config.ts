...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "TypeStaggerHeadline", formats: ["es","cjs"], fileName: (f) => (f==="es"?"type-stagger-headline.es.js":"type-stagger-headline.cjs.js") },
