...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "TypeGradientSweep", formats: ["es","cjs"], fileName: (f) => (f==="es"?"type-gradient-sweep.es.js":"type-gradient-sweep.cjs.js") },
