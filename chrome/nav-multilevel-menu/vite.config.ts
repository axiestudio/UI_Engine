...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "NavMultilevelMenu", formats: ["es","cjs"], fileName: (f) => (f==="es"?"nav-multilevel-menu.es.js":"nav-multilevel-menu.cjs.js") },
