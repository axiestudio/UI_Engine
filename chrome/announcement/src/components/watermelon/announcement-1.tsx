/**
 * Vendored from Watermelon UI registry: https://registry.watermelon.sh/r/announcement-1.json
 * Item: announcement-1 (type registry:ui). Fetched 2026-08-30. Do not edit unless intentionally adopting upstream changes.
 */
"use client";
