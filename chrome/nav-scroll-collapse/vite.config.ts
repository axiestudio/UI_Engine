...
export default defineConfig({
  ...
  build: {
    lib: { entry: path.resolve(__dirname, "src/index.ts"), name: "NavScrollCollapse", formats: ["es","cjs"], fileName: (f) => (f==="es"?"nav-scroll-collapse.es.js":"nav-scroll-collapse.cjs.js") },
