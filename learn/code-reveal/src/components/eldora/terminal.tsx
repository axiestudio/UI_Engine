/**
 * Vendored from Eldora UI (MIT): terminal — code terminal with command + typed steps.
 * Snapshot: UI/_registry/eldora-ui/r/terminal.json
 * Local patch: react-icons glyph replaced by lucide Terminal (repo icon convergence).
 */
...
function MacControls() {
  return (
    <>
      <TerminalIcon className="text-muted-foreground mr-1 size-4" />
